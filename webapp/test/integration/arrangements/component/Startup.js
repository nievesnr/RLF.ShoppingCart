sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/ui/util/Storage",
	"sap/ui/rabolagartija/cart/localService/mockserver",
	...
	return Opa5.extend("sap.ui.rabolagartija.cart.test.integration.arrangements.component.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.ui.rabolagartija.cart",
					manifest: true
				},
				hash: oOptions.hash,
